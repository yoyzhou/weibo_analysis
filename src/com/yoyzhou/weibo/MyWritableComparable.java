...
public class MyWritableComparable implements WritableComparable<MyWritableComparable>{
		...
		/**
		 * Compare two vlong pairs, return 0 only if this field1 equals that field1 and this field2 equals that field2,
		 * otherwise compare field1 then compare field2. 
		 * */
		@Override
		...
		/** A Comparator that compares serialized vlongPair. */ 
